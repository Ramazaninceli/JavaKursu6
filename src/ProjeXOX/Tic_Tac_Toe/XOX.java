...
public class XOX {
    ...
    private char MevcutOyuncu;//MevcutOyuncu

    private boolean OyunDevam;

    public XOX() {
         OyunTahtasi = new char[3][3];
        MevcutOyuncu = 'X';//MevcutOyuncu
        OyunDevam = true;
        TahtaDoldur();
    }
    ...
    public boolean KazananKontrol(char MevcutOyuncu) { //OYUNUN KAZANANININ KONTROL EDİLMESİ
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if ((OyunTahtasi[i][0] == MevcutOyuncu
                && OyunTahtasi[i][1] == MevcutOyuncu
