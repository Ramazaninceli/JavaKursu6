...
public class _03_JavaLocalTime {
    public static void main(String[] args) {
        ...
        DateTimeFormatter of2=DateTimeFormatter.ofPattern("kk:mm a");
        System.out.println("kk:mm = " + saat.format(of2));

        DateTimeFormatter of3=DateTimeFormatter.ofPattern("hh:mm a");
        System.out.println("hh:mm a = " + saat.format(of3));
        
        /**************************/
        LocalTime saat1 = LocalTime.of(7,34,56);
