...
public class _06_Sets {
    public static void main(String[] args) {
        ...
        System.out.println("birlestirme = " + birlesikHali);


        //farkı alma
        HashSet<Integer> farki=new HashSet<>();
        farki.addAll(setA);
        farki.removeAll(setB);//Ada olup  B de olmayanlar
        System.out.println("farki = " + farki);

        //Kesişen, ortak elemanlar
        HashSet<Integer> ortakElemanlar=new HashSet<>();
        ortakElemanlar.addAll(setA);
        ortakElemanlar.retainAll(setB);//A ve B deki ortak elemanları al
